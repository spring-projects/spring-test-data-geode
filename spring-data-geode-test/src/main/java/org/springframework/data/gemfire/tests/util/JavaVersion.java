...
// TODO: Replace with SDG's JavaVersions once STDG is based on SDG 2.5.6.
public abstract class JavaVersion implements Comparable<JavaVersion> {
	...
	public int hashCode() {
		...
		hashValue = 37 * hashValue + org.springframework.util.ObjectUtils.nullSafeHashCode(getMajor());
		hashValue = 37 * hashValue + org.springframework.util.ObjectUtils.nullSafeHashCode(getMinor());
